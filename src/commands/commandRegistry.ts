...
export const commandRegistry: readonly AppCommand[] = [
  ...
  { id: 'offset', labelKey: 'offset', aliases: ['of'], execute: (context) => context.activateTool('offset') },
  { id: 'trim', labelKey: 'trim', aliases: ['tr'], execute: (context) => context.activateTool('trim') },
